...
const TrendingNowShows = () => {
    ...
    useEffect(() => {
        ...
        const fetchShows = async () => {
            try {
                const response = await fetch(showsAPI({ page: 1, query: "popular" }));
                if (!response.ok) {
                    throw new Error('Network response was not ok');
                }
                const data = await response.json();
                let { results } = data;
                results = results.sort((a: Shows, b: Shows) => b.popularity - a.popularity)
                setShows(results);
            } catch (error) {
        ...
        <section className='trending-now'>
            <div className="heading">
                ...
                <div className="controller-pagination">
                    <button className={`st-prev-slide btn-dark pBtn`}>
                    ...
                    <button className={`st-next-slide btn-dark pBtn`}>
                        <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Swiper
                ...
                navigation={{
                    nextEl: ".st-next-slide",
                    prevEl: ".st-prev-slide",
                }}
                autoplay={{
                    delay: 10000,
...
export default TrendingNowShows